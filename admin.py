...
root.title("Inventory Manager(ADMIN)")
...
class login_page:
    def __init__(self, top=None):
        ...
        top.resizable(0, 0)
        top.title("INVENTORY Manager(ADMIN)")
...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.button4.configure(text="""Supplier""")
        self.button4.configure(command=suppliers)
        ...
        self.button5.configure(text="""Product""")
        self.button5.configure(command=product)
